...
const navItems = [
  { label: "Dashboard", href: "/dashboard", icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0h4", roles: ["super_admin", "hr_admin", "manager", "approver", "employee"] },
  { label: "Employees", href: "/employees", icon: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.25 2.25 0 11-4.5 0 2.25 2.25 0 014.5 0z", roles: ["super_admin", "hr_admin", "manager"] },
  ...
  { label: "Directory", href: "/directory", icon: "M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-3.07M12 6.375a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zm8.25 2.25a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z", roles: ["super_admin", "hr_admin", "manager", "approver", "employee"] },
  ...
  { label: "My Profile", href: "/profile", icon: "M17.982 18.725A7.488 7.488 0 0012 15.75a7.488 7.488 0 00-5.982 2.975m11.963 0a9 9 0 10-11.963 0m11.963 0A8.966 8.966 0 0112 21a8.966 8.966 0 01-5.982-2.275M15 9.75a3 3 0 11-6 0 3 3 0 016 0z", roles: ["super_admin", "hr_admin", "manager", "approver", "employee"] },
];
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-white border-r border-gray-200 flex flex-col z-30">
      <div className="p-5 border-b border-gray-200">
        <h1 className="text-xl font-bold text-primary-700">DataSafeguard</h1>
        <p className="text-xs text-gray-500 mt-0.5">HR Platform</p>
      </div>
      ...
      <div className="border-t border-gray-200 p-4">
        ...
        <button onClick={logout} className="w-full text-left text-sm text-gray-600 hover:text-red-600 transition-colors">
          Sign Out
        </button>
      </div>
    </aside>
