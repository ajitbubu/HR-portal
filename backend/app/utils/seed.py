...
def seed():
    ...
    try:
        ...
        emp_data = [
            ...
            (1,  "DS00002", "Lee",             "Nocon",             "lee.nocon@datasafeguard.us",              "manager",     1,   6,   9,  0,    date(2020, 6, 1)),
            (2,  "DS00003", "Mahi",            "Gupta",             "mahi.gupta@datasafeguard.us",             "employee",    1,   6,   9,  0,    date(2021, 1, 1)),
            (3,  "DS00004", "Pranab",          "Mohanty",           "pranab.mohanty@datasafeguard.us",         "employee",    1,   6,   9,  0,    date(2021, 3, 1)),
            (4,  "DS00005", "Tedra",           "Chen",              "tedra.chen@datasafeguard.us",             "employee",    1,   6,   9,  0,    date(2021, 5, 1)),
            (5,  "DS00006", "Tirthankar",      "Mitra",             "tirthankar.mitra@datasafeguard.us",       "employee",    1,   6,   9,  0,    date(2021, 7, 1)),
            (6,  "DS00007", "Ajit",            "Sahu",              "ajit.sahu@datasafeguard.us",              "manager",     3,   0,   0,  1,    date(2021, 9, 1)),
            (7,  "DS00008", "Sumeet",          "Shah",              "sumeet.shah@datasafeguard.us",            "manager",     3,   0,   0,  1,    date(2021, 11, 1)),
            (8,  "DS00009", "Ashis",           "Rout",              "ashis.rout@datasafeguard.us",             "manager",     3,   0,   0,  1,    date(2022, 1, 1)),
            (9,  "DS00010", "Santosh",         "Das",               "santosh.das@datasafeguard.us",            "manager",     3,   0,   0,  6,    date(2022, 3, 1)),
            (10, "DS00011", "Harsh",           "Nagar",             "harsh.nagar@datasafeguard.us",            "employee",    5,   0,   0,  6,    date(2022, 5, 1)),
            (11, "DS00012", "Abhisek",         "Khuntia",           "abhisek.khuntia@datasafeguard.us",        "employee",    5,   0,   0,  6,    date(2022, 7, 1)),
            (12, "DS00013", "Sourav",          "Mohapatra",         "sourav.mohapatra@datasafeguard.us",       "employee",    5,   0,   0,  6,    date(2022, 9, 1)),
            (13, "DS00014", "Soumya",          "Sootar",            "soumya.sootar@datasafeguard.us",          "employee",    5,   0,   0,  6,    date(2022, 11, 1)),
            (14, "DS00016", "Subash",          "Goswami",           "subash.goswami@datasafeguard.us",         "employee",    5,   0,   0,  6,    date(2023, 1, 1)),
            (15, "DS00017", "Dr. Anita",       "Mishra",            "dranita.mishra@datasafeguard.us",         "employee",    4,   0,   0,  9,    date(2023, 3, 1)),
            (16, "DS00018", "Bibhu",           "Behera",            "bibhu.behera@datasafeguard.us",           "employee",    5,   0,   0,  9,    date(2023, 5, 1)),
            (17, "DS00019", "Pradeepta Kumar", "Behera",            "pradeeptakumar.behera@datasafeguard.us",  "employee",    5,   0,   0,  9,    date(2023, 7, 1)),
            (18, "DS00020", "Ankita",          "Choudhury",         "ankita.choudhury@datasafeguard.us",       "employee",    5,   0,   0,  7,    date(2023, 9, 1)),
            (19, "DS00021", "Peeyush",         "Tambe",             "peeyush.tambe@datasafeguard.us",          "employee",    5,   0,   0,  7,    date(2023, 11, 1)),
            (20, "DS00022", "Prabhjyot",       "Sodhi",             "prabhjyot.sodhi@datasafeguard.us",        "employee",    5,   0,   0,  7,    date(2024, 1, 1)),
            (21, "DS00023", "Tanmay",          "Arya",              "tanmay.arya@datasafeguard.us",            "employee",    5,   0,   0,  7,    date(2024, 3, 1)),
            (22, "DS00024", "Priyanka",        "Parab",             "priyanka.parab@datasafeguard.us",         "employee",    5,   0,   0,  7,    date(2024, 5, 1)),
            (23, "DS00025", "Sainaya",         "Brid",              "sainaya.brid@datasafeguard.us",           "employee",    5,   0,   0,  7,    date(2024, 7, 1)),
            (24, "DS00026", "Trupti",          "Kokare",            "trupti.kokare@datasafeguard.us",          "employee",    5,   0,   0,  7,    date(2024, 9, 1)),
            (25, "DS00027", "Nishant",         "Selote",            "nishant.selote@datasafeguard.us",         "employee",    5,   0,   0,  7,    date(2024, 11, 1)),
            (26, "DS00028", "Yogesh",          "Kawtikwar",         "yogesh.kawtikwar@datasafeguard.us",       "employee",    5,   0,   0,  7,    date(2025, 1, 1)),
            (27, "DS00029", "Sudesna",         "Mishra",            "sudesna.mishra@datasafeguard.us",         "manager",     3,   0,   0,  8,    date(2025, 3, 1)),
            (28, "DS00030", "Debjani",         "Mohanty",           "hr@datasafeguard.us",                     "hr_admin",    6,   4,   0,  8,    date(2025, 5, 1)),
            (29, "DS00031", "Rasmita",         "Swain",             "rasmita.swain@datasafeguard.us",          "employee",    5,   0,   0,  27,   date(2025, 7, 1)),
            (30, "DS00032", "Mousumi",         "Bhattacharya Dash", "mousumi.bhattacharyadash@datasafeguard.us","employee",   7,   0,   0,  2,    date(2025, 9, 1)),
            (31, "DS00033", "Shubham",         "Pattanayak",        "shubham.pattanayak@datasafeguard.us",     "employee",    5,   0,   0,  0,    date(2025, 11, 1)),
            (32, "DS00034", "Swarnam",         "Dash",              "swarnam.dash@datasafeguard.us",           "employee",    5,   0,   0,  0,    date(2026, 1, 1)),
            (33, "DS00035", "Ritu",            "Mehta",             "ritu.mehta@datasafeguard.us",             "employee",    5,   0,   0,  5,    date(2026, 3, 1)),
        ]
